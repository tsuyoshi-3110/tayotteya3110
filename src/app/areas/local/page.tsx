...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [{ url: "https://tayotteya.shop/ogpLogo.png", width: 1200, height: 630 }],
  },
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 space-y-10">
      <header className="space-y-2">
        <h1 className="text-2xl font-bold">東淀川区の家事代行・ハウスクリーニング</h1>
      ...
      <section className="rounded-xl border bg-white/70 p-5">
        ...
        <details className="mb-2">
          ...
          <p className="text-sm mt-2">スケジュールに空きがあれば対応いたします。まずはお問い合わせください。</p>
        </details>
        <details>
          <summary className="cursor-pointer font-medium">鍵預かりや在宅不要の対応は？</summary>
          <p className="text-sm mt-2">条件を確認のうえ、適切に管理して対応可能です。</p>
        </details>
      </section>
